...
export default function ContactSection() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl w-full pointer-events-auto bg-black/60 backdrop-blur-xl border border-white/40 rounded-2xl p-8 sm:p-12 text-center shadow-[0_0_30px_rgba(255,255,255,0.15)] transition-all duration-300">
        <div className="inline-block px-3 py-1 bg-[#3ee6a8]/10 border border-[#3ee6a8]/30 rounded-full text-[11px] font-sans font-bold tracking-widest text-[#3ee6a8] uppercase mb-4">
          Get In Touch
        </div>

        <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif italic text-white mb-6">
          Let's Build Something Together
        </h2>
        
        <p className="text-gray-300 font-serif leading-relaxed mb-8 max-w-lg mx-auto text-base sm:text-lg">
        ...
        <div className="inline-block mb-10 select-none pointer-events-none">
          <div 
            ref={emailRef}
            className="text-2xl sm:text-3xl md:text-4xl font-mono font-bold text-white tracking-wider"
          >
            {handleText}
          </div>
        </div>
        ...
        <div className="flex justify-center items-center gap-5 sm:gap-6">
          ...
          <a 
            ...
            className="social-link w-12 h-12 rounded-full bg-white/5 border border-white/20 flex items-center justify-center text-gray-300 hover:text-[#3ee6a8] hover:bg-white/10 hover:border-[#3ee6a8] hover:shadow-[0_0_20px_rgba(62,230,168,0.3)] hover:-translate-y-1 transition-all duration-300 pointer-events-auto"
          >
      ...
      <div className="absolute bottom-6 left-0 right-0 text-center pointer-events-none">
        <p className="text-xs font-semibold tracking-[0.2em] text-gray-500 uppercase">
          © 2026 <span className="mx-2">·</span> Built with curiosity <span className="mx-2">·</span> Vedant Shrivastava
        </p>
      </div>
    </section>
  )
