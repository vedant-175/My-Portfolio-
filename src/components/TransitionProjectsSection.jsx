...
export default function TransitionProjectsSection() {
  const sectionRef = useRef(null)

  const ranges = useScrollStore(state => state.ranges)
  const range = ranges?.transition_projects
  ...
  useGSAP(() => {
    ...
    // Exit before Project 1 enters (recedes away)
  ...
  return (
    <section ref={sectionRef} id="transition_projects" className="relative w-full h-screen flex items-center justify-center pointer-events-none px-6 text-center z-10">
