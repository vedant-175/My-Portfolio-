...
export default function AboutSection() {
  ...
  return (
    <section ref={sectionRef} id="about" className="relative w-full h-screen flex items-center justify-center pointer-events-none px-6 overflow-hidden">
      ...
      {/* Floating Adjectives */}
      <div className="floating-adj absolute top-[20%] left-[40%] font-serif italic text-white/10 text-3xl sm:text-4xl pointer-events-none z-0">Precision</div>
      <div className="floating-adj absolute bottom-[20%] left-[15%] font-serif italic text-4xl sm:text-5xl pointer-events-none z-0">Curiosity</div>
      
      <div className="max-w-3xl w-full pointer-events-auto bg-black/50 backdrop-blur-xl border border-white/20 rounded-2xl p-6 sm:p-10 z-10 md:mr-auto md:ml-[8%] shadow-[0_0_30px_rgba(255,255,255,0.08)] flex flex-col sm:flex-row gap-6 sm:gap-8 items-center">
        <div className="shrink-0 relative group">
          <div className="w-32 h-40 sm:w-40 sm:h-48 rounded-2xl overflow-hidden border border-white/30 shadow-[0_0_25px_rgba(62,230,168,0.2)] bg-black/60">
            <img 
              src="/profile.jpg" 
          ...
          <div className="absolute -bottom-2.5 left-1/2 -translate-x-1/2 px-3 py-0.5 bg-black/90 border border-[#3ee6a8]/50 rounded-full text-[10px] font-mono font-bold tracking-wider text-[#3ee6a8] shadow-lg backdrop-blur-md uppercase whitespace-nowrap">
            Engineer
          </div>
        </div>

        <div className="flex-1 text-center sm:text-left">
          <h2 className="text-2xl sm:text-3xl font-sans font-black uppercase tracking-widest text-white mb-4 flex items-center justify-center sm:justify-start gap-3">
            <span>About</span>
            <div className="hidden sm:block h-[1px] flex-1 bg-white/10" />
          </h2>
          <p className="about-paragraph text-base sm:text-lg text-gray-300 leading-relaxed font-serif italic">
